<template>
    <section class="relative py-20">
        <div class="mx-auto max-w-screen-md text-center mb-8 lg:mb-12">
                <h1 class="mb-4 text-4xl tracking-tight font-extrabold text-gray-900 dark:text-white">Giảm trừ mức đóng BHYT hộ gia đình</h1>
                <p class="mb-5 font-light text-gray-500 sm:text-xl dark:text-gray-400">Chỉ cần nhập thẻ BHYT của các thành viên trong hộ gia đình để tính mức đóng.</p>
